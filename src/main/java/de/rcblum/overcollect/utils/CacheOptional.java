...
/**
 * Optional that expires its value after a certain time it has not been
 * accessed.
 * 
...
public class CacheOptional<T> {
	 ...
	 *          example, the following code traverses a stream of file names,
	 *          selects one that has not yet been processed, and then opens that
	 *          file, returning an {@code CacheOptional<FileInputStream>}:
	 *
	 *          <pre>
	 * {@code
